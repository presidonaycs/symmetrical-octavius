        ...
        <div className="flex-between padding" style={{backgroundColor:"#D5FFD5"}}>
          ...
          <div className="flex-between" style={{minWidth:"350px", width:"35%"}} >
              <Badge count={requestCount}>
                  <Button onClick={handleChangeTo5A} style={{fontWeight:"bold", borderRadius:"20px"}}>Request</Button>
              </Badge>
              <Badge count={5}>
                  <Button onnclick={handleChangeTo5} style={{fontWeight:"bold", backgroundColor:"transparent", border:"none"}}>Approve</Button>
              </Badge>
